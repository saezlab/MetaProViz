...
#Save Table:
write.csv(Alanine , "Alanine IDs mapped to pathways from wiki, KEGG and Reactome.csv", row.names = FALSE)
...
#Save Table:
write.csv(Plot , "MappingAmbiguity_KEGG-Glycolysis-Gluconeogenesis.csv", row.names = FALSE)
