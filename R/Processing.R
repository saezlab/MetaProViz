...
processing <- function(
  ...
  if (inherits(input_data, "SummarizedExperiment"))  {
    ...
    Se_list <- list("data_Rawdata"= input_data ,"Preprocessing_output" = se_new)
    Res_List <- list("SE"= Se_list, "DF"=Res_List[["DF"]], "Plot"= Res_List[["Plot"]])
    #Return
