...
MetaProViz::viz_heatmap(data = Intra_Preprocessed[,-c(1:4)],
                        metadata_sample = MetaData_Sample,
...
DMA_Res <- MetaProViz::dma(data=Intra_Preprocessed[,-c(1:3)], #we need to remove columns that do not include metabolite measurements
...
```{r}
#Perform ORA
DM_ORA_res <- MetaProViz::standard_ora(data= ORA_Input , #Input data requirements: column `t.val` and column `Metabolite`
