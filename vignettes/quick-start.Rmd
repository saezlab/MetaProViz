...
```
```{r show_data_preview, echo=FALSE}
...
```{r processing, fig.width=6, fig.height=4.5, fig.align="left"}
...
```{r show_preprocessing_results, echo=FALSE}
# Check how our data looks like:
...
```{r pca_plot, fig.align="left", fig.width=6, fig.height=4.5, fig.cap="Figure: Do the samples cluster for the Cell type?"}
...
```{r heatmap_plot, fig.align="left", fig.cap="Colour for sample metadata."}
...
```{r dma, fig.width=7, fig.height=5, fig.align="left"}
...
```{r show_mca_2cond_rules, echo=FALSE}
# Check how our data looks like:
MCA2Cond_Rules%>%
...
```{r show_mca_core_rules, echo=FALSE}
# Check how our data looks like:
MCA_CoRe_Rule[,1:6]%>%
