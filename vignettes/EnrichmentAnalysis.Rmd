...
*Transition to next headline: Enrichment analysis and detection (maybe show figure here).

To use the prior knowledge for enrichment analysis, we would want to keep the metabolite IDs across pathways consistent, avoid ambiguous mapping as much as possible (many-to-many mapping), and have this metabolite ID selection guided by any IDs we might have available to us in our measured input data.
