...
\
As visible from the prior knowledge tables above, it becomes clear that we require a specific metabolite ID depended on the prior knowledge resource. Indeed, the KEGG pathways include KEGG IDs, whilst the Hallmarks metabolite sets include HMDB IDs.\
...
```
\
However there are some important caveats with the standard TranslateID function, which we will discuss briefly here (Fig.2).
