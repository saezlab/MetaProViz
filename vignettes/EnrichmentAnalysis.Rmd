...
![Fig. 2: Mapping problems in prior knowledge metabolite-sets when translating metabolite IDs.](Fig.2.png){alt="Fig. 2: Mapping problems in prior knowledge metabolite-sets when translating metabolite IDs." width="50%"}
