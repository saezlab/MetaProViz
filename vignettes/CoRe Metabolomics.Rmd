...
```{r, eval=FALSE}
Pool_Estimation_result<- MetaProViz::Pool_Estimation(Input_data = Media[,-c(1:3)],
                            Input_SettingsFile = Media[,1:3],
...
DMA_Annova <-  MetaProViz::DMA(Input_data=Media_Preprocessed[,-c(1:4)],
                               Input_SettingsFile_Sample=Media_Preprocessed[,c(1:4)],
