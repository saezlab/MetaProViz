...
```{r}
#  When  Plot_Settings="Compare" colorcoding of hte different datasets is usel. Thus we can change only the size of the dots using the Plot_SettingsFile
MetaProViz::VizLolipop(Input_data = list(`DMA_HK2_vs_786-O`,`DMA_HK2_vs_786-M1A`),
...
daniel, pau, robin (single cell) --> there was someone on a conference Aurelien mentioned 
