...
# Save
Plot_Sized <- MetaProViz:::PlotGrob_Heatmap(InputPlot=heatmap, SettingsInfo=NULL, SettingsFile_Sample=NULL, SettingsFile_Metab=NULL, PlotName= "test")
Plot_Sized %<>%
...
MCA_CoRe_res <- MetaProViz::MCA_CoRe(InputData_Intra =Intra_DMA_786M1A_vs_HK2%>%rownames_to_column("Metabolite") ,
                                     ...
                                     SettingsInfo_Intra=c(ValueCol="Log2FC",StatCol="p.adj", StatCutoff= 0.05, ValueCutoff=0.8),
...
MetaProViz::VizHeatmap(InputData = Input_Plot,
                       ...
                       SettingsFile_Metab =  MetaData_Metab_RG2,
                       PlotName = "Pathway")
