...
for(item in names(DFs)){
  ...
  TvN <- MetaProViz::DMA(InputData =  InputData[,-c(1:13)],
                   ...
                   FolderPath = paste(getwd(),"/MetaProViz_Results/DMA/", item, sep="")) 
...
for(comparison in names(ResList)){
  ...
  #Perform ORA
  Res <- MetaProViz::StandardORA(InputData= DMA_Select, #Input data requirements: column `t.val` and column `Metabolite`
                                 ...
                                 PathwayName=paste0("KEGG_", comparison, sep=""),
                                 minGSSize=3,
                                 maxGSSize=1000,
                                 pCutoff=0.01,
                                 PercentageCutoff=10)
  ...
  if(is.null(Res_Select)==FALSE){
     MetaProViz::VizVolcano(PlotSettings="PEA",
                       ...
                       InputData2=as.data.frame(Res_Select )%>%dplyr::rename("term"="ID"),
...
MetaProViz::VizVolcano(PlotSettings="Compare",
                       ...
                       ComparisonName= c(InputData="Young", InputData2= "Old"),
                       SettingsFile_Metab =  MetaData_Metab,
                       PlotName= "Young-TUMOR_vs_NORMAL compared to Old-TUMOR_vs_NORMAL_Sub",
                       Subtitle= "Results of DMA",
                       SettingsInfo = c(individual = "SUB_PATHWAY",
                                        color = "RG2_Significant"))
```
\
<div class="vscroll-plot">
...
MetaProViz::VizVolcano(PlotSettings="Compare",
                       ...
                       SettingsInfo = c(individual = "SUPER_PATHWAY",
                                        color = "RG2_Significant"),
                       ColorPalette = c(Cond1_DOWN="#0694B9", Cond2_DOWN="#38BEEF",Cond1_UP="#F1E644", Cond2_UP= "#DE963F", Core_DOWN="#2F358B", Core_UP="#BD1F2D", Opposite="#10AC8D", None="#969697"))
