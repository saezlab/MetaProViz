...
```{r}
# Load the example data:
FeatureMetadata_Biocrates <- MetaProViz::ToyData(Data="")
```
\
\
...
:::
:::
# 2. Metabolite IDs in measured data
...
--> Christina: Add/showcase new function!
...
# 4. Linking experimental data to prior knowledge
...
--> For MEtaLinksDB, we could show all feature metadata examples (cells, tissues, Biocrates)
