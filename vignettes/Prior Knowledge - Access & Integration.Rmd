...
# 5. Metabolite IDs in measured data
...
## 5.1 Use measured Metabolite IDs to guide the selection of PK IDs
...
## 5.2. Assigning Metabolite IDs to measured data
