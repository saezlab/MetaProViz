...
cat(sprintf(
    ...
    "https://raw.githubusercontent.com/saezlab/MetaProViz/main/vignettes/pkgdown/prior-knowledge.Rmd_compare-pk.svg"
))
```
\
...
cat(sprintf(
    '<img src="%s" width="100%%" style="display:block; margin:0 auto;"/>',
    "https://raw.githubusercontent.com/saezlab/MetaProViz/main/vignettes/pkgdown/prior-knowledge.Rmd_compare-pk-2.svg"
))
```
\
...
cat(sprintf(
    '<img src="%s" width="100%%" style="display:block; margin:0 auto;"/>',
    "https://raw.githubusercontent.com/saezlab/MetaProViz/main/vignettes/pkgdown/prior-knowledge.Rmd_compare-pk-3.svg"
))
```
\
