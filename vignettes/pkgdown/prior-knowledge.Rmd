...
biocrates_metalinks_receptor <- viz_metabolite_protein_network(
  feature_metadata = biocrates_features,
  metalinks_df = metalinks_receptor,
  metabolite_col = "TrivialName",
  hmdb_col = "HMDB",
  save_plot = NULL,
  path = NULL,
  plot_name = "biocrates_to_metalinks_receptor_network",
...
biocrates_metalinks_transporter <- viz_metabolite_protein_network(
  ...
  save_plot = NULL,
  path = NULL,
  plot_name = "biocrates_to_metalinks_transporter_network",
  hmdb_sep = ",",
  return_data = TRUE,
  print_plot = TRUE,
  full_labels = FALSE,
...
biocrates_metalinks_metabolic_enzyme <- viz_metabolite_protein_network(
  ...
  save_plot = NULL,
  path = NULL,
  plot_name = "biocrates_to_metalinks_metabolic_enzyme_network",
  hmdb_sep = ",",
  return_data = TRUE,
  print_plot = TRUE,
  full_labels = FALSE,
