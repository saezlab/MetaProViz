...
For a better overview, see both these plots again below:
```{r}
print(biocrates_metalinks_receptor$plot)
print(biocrates_metalinks_receptor$metabolite_interaction_overlap$plot)
```
...
<strong>See the metsigdb-resouces-composition vignette for an in-depth investigation of all MetSigDB resources </strong>
:::
