...
*Send users to enrichment vignette if there are interested in accessing and using metabolite prior knowledge for enrichment analysis.



*can we use metadata analysis to find separators of one cell type from the rest (e.g. when multiple cell lines are plotted on the PCA)
* can we extract confounding factors, as in demographics that change together.
