...
MetaProViz::VizSuperplot(InputData =Input_Plot%>%select(all_of(Metabolite_list)),#We just plot selected metabolites
                                           SettingsFile_Sample =MetaData_Sample%>% dplyr::filter(Conditions %in% c("HK2", "786-O", "786-M1A")),
                                           SettingsInfo = c(Conditions="Conditions", Superplot = "Biological_Replicates"),
                                           PlotType = "Bar", #Bar, Box, Violin
