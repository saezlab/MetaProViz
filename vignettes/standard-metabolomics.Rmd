...
```{r, eval=FALSE}
PreprocessingResults <- MetaProViz::pre_processing(data=Intra[-c(49:58) ,-c(1:3)], #remove pool samples and columns with sample information
...
MCAres <-  MetaProViz::mca_2cond(data_c1=DMA_Annova[["dma"]][["786-O_vs_HK2"]],
                                 ...
                                 metadata_info_c1=c(ValueCol="Log2(Distance)",StatCol="p.adj", cutoff_stat= 0.05, ValueCutoff=1),
                                 metadata_info_c2=c(ValueCol="Log2(Distance)",StatCol="p.adj", cutoff_stat= 0.05, ValueCutoff=1),
                                 feature = "Metabolite",
                                 save_table = "csv",
