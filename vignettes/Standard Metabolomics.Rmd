...
```
```{r, echo=FALSE}
Pool_Estimation_result_DF <- Pool_Estimation_result[["DF"]]
...
# Check the plots
Pool_Estimation_result_Plots <- Pool_Estimation_result[["Plot"]]
Pool_Estimation_result_Plots
```
\
...
Intra_Preprocessed <- PreprocessingResults[["DF"]][["Preprocessing_output"]][["Processed_data"]]
```
```{r, echo=FALSE}
# Check how our data looks like:
...
#1.PCA plot
P1 <- PreprocessingResults[["Plot"]][["Outlier_plots"]][["PCA_round1"]]
#P1

#2.Screeplot
P2 <- PreprocessingResults[["Plot"]][["Outlier_plots"]][["ScreePlot_round1"]]
#P2

#3.Hotellins Outlier
P3 <-  PreprocessingResults[["Plot"]][["Outlier_plots"]][["HotellingsPlot_round1"]]
P3
...
P4<- PreprocessingResults[["Plot"]][["Outlier_plots"]][["PCA_round2"]]
P4
P5<- PreprocessingResults[["Plot"]][["Outlier_plots"]][["ScreePlot_round2"]]
P5
P6<- PreprocessingResults[["Plot"]][["Outlier_plots"]][["HotellingsPlot_round2"]]
P6
```
\
...
# PCA plot
# 1. Marked Outliers:
Q1 <- PreprocessingResults[["Plot"]][["QC_plots"]][["QC_PCA_and_Outliers"]]
Q1

#2. Marked Biological replicates:
Q2 <- PreprocessingResults[["Plot"]][["QC_plots"]][["QC_PCA_Replicates"]]
Q2
```
\
...
`DMA_786-O_vs_HK2`<- DMA_786O_vs_HK2[["DF"]][["DMA_result"]]#Get the DMA table
...
`DMA_786-M1A_vs_HK2` <- DMA_786M1A_vs_HK2[["DF"]][["DMA_result"]]#Get the DMA table
...
`DMA_786-M2A_vs_HK2` <- DMA_786M2A_vs_HK2[["DF"]][["DMA_result"]]#Get the DMA table
...
MC_ORA_result<- MetaProViz::MC_ORA(Input_data=MCAres[["DF"]][["MCA_result"]],
