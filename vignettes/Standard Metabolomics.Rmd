...
Note: Prepare the MetSigDB KEGG pathways based on KEGG IDs. Provide both: A mapping where we have one pathway assigned to one metabolite and the file for the Pathway analysis.
```{r}
...
Show:
Quality_Control_PCA/PCA_Condition_Clustering.svg){width=100%}
Hotelling_OD_round_1.svg){width=100%}
...
--> point towards 3. Run MetaProViz Visualisation --> PCA options and heatmaps could both be usefull to have a closer look at the results!
