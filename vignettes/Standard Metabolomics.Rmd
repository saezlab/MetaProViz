...
2. Standard Log2FC: log2(Mean(Condition1)) - log2(Mean(Condtio2))
...
#Inspect the DMA table:
DMA_786M1A_vs_HK2 <- DMA_Annova[["DF"]][["DMA_result"]][["786-M1A_vs_HK2"]]
Shapiro <- DMA_Annova[["DF"]][["Shapiro_result"]]

#Shapiro order is not right!
```
```{r, echo=FALSE}
# Check how our data looks like:
Shapiro[,1:8]%>%
