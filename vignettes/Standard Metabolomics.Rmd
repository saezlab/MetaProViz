...
# The Pool_Estimation_result is a List of 2 containing DFs and Plots with the results. 
#We can check the plots:
Pool_Estimation_result[["Plots"]][[1]]
Pool_Estimation_result[["Plots"]][[2]]
Pool_Estimation_result[["Plots"]][[3]]

#We can check the main results DF:
CV_results <- Pool_Estimation_result[["DFs"]][["CV_result"]]
```
```{r, echo=FALSE}
# Check how our data looks like:
CV_results[1:5,]%>%
