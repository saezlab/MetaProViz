...
```{r}
MetaProViz::ToyData(data="Standard")
```
```{r, echo=FALSE}
...
#### Select Pool samples:
#Get the Pool data
PoolData <- MetaProViz::ToyData(data="Standard") %>%
...
use results list and make grid of metabolites of a specific pathway!
```{r}

MetaProViz::Vizsuperplot(Input_data = Intra_Preprocessed[,-c(1:3, 10:182)],
                          Plot_SettingsFile = Intra_Preprocessed[,c(1:2)],
                          Plot_SettingsInfo = c(conditions="Conditions", superplot = "Biological_Replicates"),
                          ...
                          Theme = theme_classic(),
                          Save_as_Plot = "pdf") #for together it always pdf
...
MetaProViz::VizHeatmap(InputData = Input_Heatmap, 
                       SettingsFile_Sample = MetaData_Sample,
                       SettingsInfo = c(individual_Metab = "RG2_Significant",
...
MetaProViz::VizHeatmap(InputData = Input_Heatmap, 
                       SettingsFile_Sample = MetaData_Sample,
                       SettingsInfo = c(individual_Metab = "Pathway", color_Sample = list("Conditions","Biological_Replicates"), color_Metab = list("RG2_Significant")),
                       SettingsFile_Metab =  MetaData_Metab,
                       PlotName = "Pathway")
```
...
MetaProViz::VizVolcano(Plot_Settings="Standard",
                       ...
                       Plot_SettingsFile= MetaData_Metab,
                       Input_data=DMA_786M1A_vs_HK2%>%column_to_rownames("Metabolite"),
                       OutputPlotName= "786M1A versus HK2",
                       Subtitle= "Results of DMA. Colour for metabolic pathways." )
```
...
MetaProViz::VizVolcano(PlotSettings="Compare",
                       ...
                       SettingsFile_Metab= MappingInfo[,c(1,5)]%>%column_to_rownames("Metabolite"),
                       InputData=DMA_786M1A_vs_HK2%>%column_to_rownames("Metabolite"),
                       InputData2= DMA_Annova[["DMA"]][["786-O_vs_HK2"]]%>%column_to_rownames("Metabolite"),
                       PlotName= "786M1A vs HK2 compared to 7860 vs HK2",
                       Subtitle= "Results of DMA" )
...
MetaProViz::VizVolcano(PlotSettings="PEA",
                       SettingsInfo= c(individual="term", PEA_Pathway="ID", PEA_stat="p.adjust", PEA_score="GeneRatio"),
                       SettingsFile_Metab= KEGG_Pathways[,-c(3)],#Must be the pathways used for pathway analysis
                       InputData= DMA_786M1A_vs_HK2%>%column_to_rownames("Metabolite"),# Must be the data you have used as an input for the pathway analysis
                       InputData2= DM_ORA_786M1A_vs_HK2,#Must be the results of the pathway analysis
                       PlotName= "KEGG",
                       Subtitle= "PEA" ,
                       SelectLab = NULL)
