...
MetaProViz::VizHeatmap(Input_data = Heatmap_data,
                       Plot_SettingsFile_Sample = Heatmap_design,
                       Plot_SettingsInfo = c(col_annotation = list("Conditions","Biological_Replicates")),
                       OutputPlotName = "Colour Samples")

# row annotation
MetaProViz::VizHeatmap(Input_data = Heatmap_data,
                       Plot_SettingsFile_Sample = Heatmap_design,
                       Plot_SettingsInfo = c(row_annotation = list("Pathway")),
...
MetaProViz::VizHeatmap(Input_data = Heatmap_data, 
                       Plot_SettingsFile_Sample = Heatmap_design,
                       Plot_SettingsInfo = c(individual = "Pathway",col_annotation = list("Conditions","Biological_Replicates"),row_annotation = list("Pathway")),
                       Plot_SettingsFile_Metab =  MappingInfo,
                       OutputPlotName = "All")
...
To do:
1. If individual, change the sub-name to the pathway name!
2. Can individual also be used for samples? --> If not change this
3. change the Plot_SettingsInfo column names that should be used.
