...
```
\
Using the normalized we can now use the **MetaProViz** visualisation module 
PCA options and heatmaps could both be usefull to have a closer look at the results!
