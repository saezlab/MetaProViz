...
```{r, fig.align="center", fig.width=8, fig.height=6, fig.cap="Figure: Standard figure displaying DMA results."}
...
```{r, fig.align="center", fig.width=8, fig.height=6, fig.cap="Figure: Standard figure displaying DMA results colour coded/shaped for metabolic clusters from MCA results."}
...
```{r, fig.align="center", fig.width=8, fig.height=6, fig.cap="Figure: Standard figure displaying DMA results colour coded for metabolic pathways and shaped for metabolic clusters from MCA results."}
...
```{r, fig.align="center", fig.width=8, fig.height=6, fig.cap="Figure: Standard figure displaying DMA results for each pathway, colour coded for metabolic clusters from MCA results."}
...
```{r, fig.align="center", fig.width=6, fig.height=6, fig.cap="Figure: Comparison."}
