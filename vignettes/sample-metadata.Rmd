...
The `MetaProViz::meta_analysis()` function will perform PCA to extract the different PCs followed by annova to find the main metabolite drivers that separate patients based on their demographics.\
\
```{r}
MetaRes <- MetaProViz::meta_analysis(data=Tissue_Norm[,-c(1:13)],
