...
repository at `../saezverse/` (<https://github.com/saezlab/saezverse>)
is a central knowledge base for cross-package coordination. It contains:

- **Package descriptions** (`human/packages/`) — including
  `metaproviz.md`
...
When working on MetaProViz, consult the saezverse repo for: - R coding
style conventions: `../saezverse/human/guidelines/r-coding-style.md` -
R/Bioc development workflow:
`../saezverse/human/guidelines/r-bioc-package-workflow.md` -
